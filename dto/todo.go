...
type CreateTodoRequest struct {
	...
	Description string `json:"description" validate:"required,min=1,max=255" example:"test"`
...
type UpdateTodoRequest struct {
	...
	Description string    `json:"description" validate:"min=1,max=255" example:"updated test"`
